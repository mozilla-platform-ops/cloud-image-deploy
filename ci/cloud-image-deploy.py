...
createTask(
    ...
    taskId = slugid.nice(),
    taskName = '01 :: apply {} configurations from {}'.format(environment, commitSha[:7]),
    taskDescription = 'apply {} taskcluster configurations from [{}/{}](https://github.com/mozilla-platform-ops/cloud-image-deploy/tree/{}/.deploy/{})'.format(environment, commitSha[:7], environment, commitSha[:7], environment),
    maxRunMinutes = 10,
    retries = 2,
    ...
    scopes = [
        ...
        'auth:update-role:worker-pool:gecko-1/b-win*',
        'auth:update-role:worker-pool:gecko-1/win*',
        'auth:update-role:worker-pool:gecko-t/t-win*',
