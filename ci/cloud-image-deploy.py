...
createTask(
    ...
    taskId = slugid.nice(),
    taskName = '01 :: deploy {} configurations from {}'.format(environment, commitSha[:7]),
    taskDescription = 'apply taskcluster configurations from https://github.com/mozilla-platform-ops/cloud-image-deploy/tree/{}/.deploy/{}'.format(commitSha[:7], environment),
    maxRunMinutes = 10,
    retries = 2,
